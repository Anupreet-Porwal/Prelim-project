...
for (i in 1:length(w.c)){
  for (j in 1:length(xi.c)){
    ...
    print(paste("w=",w.c[i],",zeta=",xi.c[j]))
...
# \hline
# MLE & 246.12 & 254.03 \\
# Double-Exponential & 101.92 & 88.88 \\
# NEG(c=4,d=3) & 139.71 & 125.67 \\
# NEG(c=2,d=3) & 163.89 & 150.63 \\
# NEG(c=1,d=3) & 180.61 & 166.05 \\
# NEG(c=0.5,d=3) & 192.00 & 180.23 \\
# Empirical Bayes & 31.35 & 38.71 \\
# NEG(best fixed c,d) & 75.75 & 55.70 \\
# Horseshoe & 30.37 & 34.76 \\
# \hline
# \end{tabular}
# \end{table}
# 
...
# \hline
# MLE & 252.39 & 249.10 \\ 
# Double-Exponential & 157.42 & 144.47 \\ 
# NEG(c=4,d=3) & 205.04 & 172.24 \\ 
# NEG(c=2,d=3) & 223.57 & 195.99 \\ 
# NEG(c=1,d=3) & 235.17 & 212.91 \\ 
# NEG(c=0.5,d=3) & 241.77 & 223.58 \\ 
# Empirical Bayes & 114.14 & 122.74 \\ 
# NEG(best fixed c,d) & 166.84 & 121.35 \\ 
# Horseshoe & 100.00 & 92.98 \\ 
# \hline
# \end{tabular}
# \end{table}
# 
...
# \hline
# MLE & 247.55 & 245.08 \\ 
# Double-Exponential & 248.82 & 269.29 \\ 
# NEG(c=4,d=3) & 214.87 & 191.27 \\ 
# NEG(c=2,d=3) & 228.90 & 208.09 \\ 
# NEG(c=1,d=3) & 236.49 & 220.57 \\ 
# NEG(c=0.5,d=3) & 240.91 & 228.73 \\ 
# Empirical Bayes & 390.43 & 464.89 \\ 
# NEG(best fixed c,d) & 194.08 & 179.86 \\ 
# Horseshoe & 175.37 & 271.76 \\ 
# \hline
# \end{tabular}
# \end{table}
